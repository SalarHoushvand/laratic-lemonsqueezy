<div>
    ...
    >
        ...
        <div class="flex flex-col gap-1 w-full">
            <x-input-label 
                for="phone" 
                :value="__('Phone Number (optional)')" 
        ...
        <!-- Message Section -->
        <div 
            class="flex flex-col gap-1 w-full col-span-1 md:col-span-2"
            x-data="{
                messageLength: 0,
                maxLength: 600,
                init() {
        ...
        >
            <div class="flex justify-between">
                ...
                <span 
                    class="text-xs"
                    x-bind:class="messageLength >= maxLength ? 'text-danger font-bold' : 'text-on-surface/60 dark:text-on-surface-dark/60'"
                    x-text="`${messageLength}/${maxLength}`"
                ></span>
            </div>
            <x-text-area 
                id="message" 
                ...
                class="w-full" 
                rows="4" 
                :placeholder="__('Your message goes right here ...')"
                :error="$errors->has('message')" 
                required
                x-ref="messageField"
                x-on:input="messageLength = $el.value.length"
            ></x-text-area>
        ...
        <div class="flex flex-col gap-4 w-full col-span-1 md:col-span-2">
            ...
            <div class="flex gap-3">
                <x-checkbox 
                    id="phone_consent"
                    wire:model="phone_consent" 
                    :error="$errors->has('phone_consent')" 
                />
                <x-input-label class="!mt-0 inline" for="phone_consent">
            ...
            <div class="flex gap-3">
                <x-checkbox 
                    ...
                    :error="$errors->has('marketing_consent')" 
                />
