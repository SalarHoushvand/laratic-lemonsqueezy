<x-layouts.guest>
    @push('head')
        <title>401 - {{ __('Unauthorized') }} | {{ config('app.name', 'Laravel') }}</title>
        <meta name="description" content="{{ __('You must be authenticated to access this page.') }}">
    @endpush
        ...
        <div class="mx-auto max-w-2xl text-center">
            ...
            <div class="mb-8 space-y-4">
                ...
                <p class=" text-on-surface-muted dark:text-on-surface-dark-muted">
                    {{ __('You must be logged in to access this page. Please sign in to continue.') }}
                </p>
            </div>
