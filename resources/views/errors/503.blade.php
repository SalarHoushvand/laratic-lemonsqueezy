<x-layouts.guest>
    @push('head')
        <title>503 - {{ __('Service Unavailable') }} | {{ config('app.name', 'Laravel') }}</title>
        <meta name="description" content="{{ __('The service is temporarily unavailable. We are performing maintenance.') }}">
    @endpush
        ...
        <div class="mx-auto max-w-2xl text-center">
            ...
            <div class="mb-8 space-y-4">
                ...
                <p class=" text-on-surface-muted dark:text-on-surface-dark-muted">
                    {{ __('We\'re currently performing maintenance or experiencing high traffic. Please check back in a few moments.') }}
                </p>
            </div>
