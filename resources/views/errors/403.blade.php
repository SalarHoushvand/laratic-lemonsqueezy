<x-layouts.guest>
    @push('head')
        <title>403 - {{ __('Forbidden') }} | {{ config('app.name', 'Laravel') }}</title>
        <meta name="description" content="{{ __('You do not have permission to access this resource.') }}">
    @endpush
        ...
        <div class="mx-auto max-w-2xl text-center">
            ...
            <div class="mb-8 space-y-4">
                ...
                <p class=" text-on-surface-muted dark:text-on-surface-dark-muted">
                    {{ __('You do not have permission to access this page. If you believe this is an error, please contact support.') }}
                </p>
            </div>
