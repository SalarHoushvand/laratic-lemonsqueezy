<x-layouts.guest>
    @push('head')
        <title>400 - {{ __('Bad Request') }} | {{ config('app.name', 'Laravel') }}</title>
        <meta name="description" content="{{ __('The request could not be understood by the server.') }}">
    @endpush
        ...
        <div class="mx-auto max-w-2xl text-center">
            ...
            <div class="mb-8 space-y-4">
                ...
                <p class=" text-on-surface-muted dark:text-on-surface-dark-muted">
                    {{ __('The server could not understand your request. Please check your input and try again.') }}
                </p>
            </div>
            ...
            <div class="flex flex-col items-center justify-center gap-4 sm:flex-row">
                ...
                <x-button href="javascript:history.back()" variant="outline">
                    {{ __('Go Back') }}
                </x-button>
            </div>
