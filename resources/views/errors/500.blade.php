<x-layouts.guest>
    @push('head')
        <title>500 - {{ __('Server Error') }} | {{ config('app.name', 'Laravel') }}</title>
        <meta name="description" content="{{ __('An internal server error occurred. We are working to fix this issue.') }}">
    @endpush
