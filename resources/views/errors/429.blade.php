<x-layouts.guest>
    @push('head')
        <title>429 - {{ __('Too Many Requests') }} | {{ config('app.name', 'Laravel') }}</title>
        <meta name="description" content="{{ __('You have made too many requests. Please wait a moment and try again.') }}">
    @endpush
        ...
        <div class="mx-auto max-w-2xl text-center">
            ...
            <div class="mb-8 space-y-4">
                ...
                <p class=" text-on-surface-muted dark:text-on-surface-dark-muted">
                    {{ __('You have made too many requests in a short period. Please wait a moment and try again.') }}
                </p>
            </div>
