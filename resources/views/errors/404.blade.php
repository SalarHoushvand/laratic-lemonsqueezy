<x-layouts.guest>
    @push('head')
        <title>404 - {{ __('Page Not Found') }} | {{ config('app.name', 'Laravel') }}</title>
        ...
        <div class="mx-auto max-w-2xl text-center">
            ...
            <div class="mb-8 space-y-4">
                ...
                <p class=" text-on-surface-muted dark:text-on-surface-dark-muted">
                    {{ __('Sorry, we couldn\'t find the page you\'re looking for. Perhaps you\'ve mistyped the URL or the page has been moved.') }}
                </p>
            </div>
