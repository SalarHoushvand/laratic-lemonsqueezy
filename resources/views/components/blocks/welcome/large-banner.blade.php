@php
    $lightImages = [
        ...
        ['src' => asset('images/homepage-slideshow/slide-4-light.webp'), 'caption' => __('Manage subscriptions with Paddle payments.')],
    ...
    $darkImages = [
        ...
        ['src' => asset('images/homepage-slideshow/slide-4-dark.webp'), 'caption' => __('Manage subscriptions with Paddle payments.')],
