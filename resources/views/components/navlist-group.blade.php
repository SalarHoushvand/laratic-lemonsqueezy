...
>
    ...
    >
        <div class="ps-3 pe-4">
            <x-icons.chevron-down class="hidden size-3! group-data-open/disclosure-button:block" />
            <x-icons.chevron-right class="block size-3! group-data-open/disclosure-button:hidden" />
        </div>
